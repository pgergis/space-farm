...
sprite_defs[5]={104,0,16,16} -- null
...
function add_sprite(x,y,sprite_offset)
    ...
    if sprite_offset==5 then
        printh("DELETING")
        sprite_map[x][y]=nil
    else
        if get_color(player.selected_tile_x, player.selected_tile_y) == 12 then return end
        sprite_map[x][y]={offset=sprite_offset,id=sprite_counter}
    end
end

function plant_thing(x,y)
    if player.current_plant~=5 and sprite_map[x] and sprite_map[x][y] then 
        return 
    end
    add_sprite(x,y,player.current_plant)
end
...
function _draw()
    ...
    local current_plant=sprite_defs[player.current_plant]
    printh(player.current_plant)
    sspr(
        current_plant[1],
        current_plant[2],
        current_plant[3],
...
function player:cycle_plant()
    self.current_plant=1+(self.current_plant+1)%#sprite_defs
end
...

